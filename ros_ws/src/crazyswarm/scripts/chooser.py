...
if __name__ == '__main__':
	...
	pixel_x = [320 * dot(pos, RIGHT_DIR) for pos in positions]
	pixel_y = [320 * dot(pos, DOWN_DIR) for pos in positions]
	...
	width = xmax - xmin + 150 # account for checkbox + text width
	height = ymax - ymin + 150 # account for checkbox + text height
